...
geofence = [
    (15.3675662, 75.1253995),  # Bottom-Left
    (15.3671912, 75.1252976),  # Bottom-Right
    (15.3671110, 75.1257536),  # Top-Right
    (15.3675042, 75.1258314)   # Top-Left
]
x_divisions = 11
y_divisions = 13
altitude = 15
...
def detectionClassify():
    ...
    try:
        while not stop_thread:
            ...
            if targetDetectFlag and targetCount >= 3:
...
def go_to_location(latitude, longitude, altitude):
    ...
    vehicle.simple_goto(target_location, groundspeed=3.2)
        ...
        while True:
            ...
            if prev_x is not None and prev_y is not None:
                if x_coord == prev_x and y_coord == prev_y:
                    ...
                    send_velocity_based_on_position(x_coord, y_coord, 0.1, 0.2)
...
def main():
    ...
    try:
        ...
        # go_to_target(15.367641317816378,75.12555770181555,altitude)
        time.sleep(4)
