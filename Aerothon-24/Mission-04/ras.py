...
geofence = [
    (15.3676529, 75.1257469),  # Bottom-Left
    (15.3677046, 75.1232022),  # Bottom-Right
    (15.3672649, 75.1252976),  # Top-Right
    (15.3672326, 75.1257120)   # Top-Left
]
x_divisions = 15
y_divisions = 11
altitude = 15
                ...
                if ((scores[i] > min_conf_threshold) and (scores[i] <= 1.0)):
                    ...
                    if object_name == "target" :
                       with open("YelloWcoordinates.txt", "a") as f:
                               f.write(f"{cx}, {cy} \n")
                               #print("The coordinates: target",cx,cy,object_name)  
...
def moveTotarget():
    ...
    def moveTotargetPoint():
        ...
        while True:
            ...
            if prev_x is not None and prev_y is not None:
                if x_coord == prev_x and y_coord == prev_y:
                    ...
                    send_velocity_based_on_position(x_coord, y_coord, 0.3, 0.3)
        ...
        for i in range(5):
            ...
            time.sleep(0.6)
            print("points yellow=",x_coord,y_coord)
            ...
            if prev_x is not None and prev_y is not None:
                if x_coord == prev_x and y_coord == prev_y:
                    ...
                    send_velocity_based_on_position(x_coord, y_coord, 0.25, 0.25)
...
def main():
    ...
    try:
        ...
        go_to_target(LocationGlobalRelative(15.367697908192312,75.12576753845622,altitude),altitude)
        time.sleep(4)
