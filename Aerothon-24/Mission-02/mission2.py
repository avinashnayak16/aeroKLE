...
geofence = [
    (15.3693223, 75.1261747),  # Bottom-Left
    (15.3691413, 75.1262002),  # Bottom-Right
    (15.3691387, 75.1263973),  # Top-Right
    (15.3693534, 75.1263571)   # Top-Left
]
x_divisions = 10
y_divisions = 10
altitude = 15
            ...
            if shapeFlag == True:
                ...
                for i in range(len(scores)):
                    if ((scores[i] > min_conf_threshold) and (scores[i] <= 1.0)):
                        ...
                        if (object_name == "objects") and targetDetectFlag:
...
def shapesDetection(frame):
    ...
    text = f"Squares: {total_square_count}, Circles: {total_circle_count}"
...
def take_picture():
    global targetDetectFlag  # Add this line to modify the global variable
