...
geofence = [
    (15.3674292, 75.1251957),  # Bottom-Left
    (15.3672636, 75.1251179),  # Bottom-Right
    (15.3672248, 75.1253244),  # Top-Right
    (15.3673955, 75.1253888)   # Top-Left
]
x_divisions = 11
y_divisions = 7
altitude = 15
            ...
            while not yellowThread:              
                ...
                if largest_contour is not None and len(largest_contour) >= 5:
                    ...
                    if M["m00"] != 0:
                        ...
                        with open("YelloWcoordinates12.txt", "a") as f:
                            f.write(f"{cx}, {cy}\n")
