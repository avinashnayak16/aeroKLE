...
geofence = [
    (15.3674770, 75.1252198),  # Bottom-Left
    (15.3672016, 75.1251689),  # Bottom-Right
    (15.3671912, 75.1255095),  # Top-Right
    (15.3674783, 75.1255269)   # Top-Left
]
x_divisions = 15
y_divisions = 10
altitude = 15
...
tarLocation = (vehicle.location.global_relative_frame.lat,vehicle.location.global_relative_frame.lon,altitude)
...
def moveTotarget():
    ...
    def moveTotargetPoint():
        ...
        #while True:
            ...
            if((abs(x_coord-h_x)<=40) and (abs(y_coord-h_y)<=40)) and vehicle.location.global_relative_frame.alt <=5:
                break
        time.sleep(1)
...
def main():
    ...
    try:
        ...
        print("target location",tarLat,tarLon,alti)
