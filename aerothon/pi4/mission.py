...
geofence = [
    (15.3677990, 75.1254719),  # Bottom-Left
    (15.3674602, 75.1253808),  # Bottom-Right
    (15.3674007, 75.1256597),  # Top-Right
    (15.3677499, 75.1257455)   # Top-Left
]
x_divisions = 8
y_divisions = 12
altitude = 15
...
def moveToavi():
    ...
    while True:
        ...
        if((abs(x_coord-h_x)<=35) and (abs(y_coord-h_y)<=35)):
            break
...
def moveTotarget():
    ...
    def moveTotargetPoint():
        ...
        while True:
            ...
            if((abs(x_coord-h_x)<=35) and (abs(y_coord-h_y)<=35)) and vehicle.location.global_relative_frame.alt <=5:
                break
        time.sleep(1)
    ...
    tarLocation = (tarLocation ,altitude) 
